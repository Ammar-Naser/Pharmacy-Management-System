...
namespace PharmacyManagementSystem.Forms
{
    public partial class CustomersForm : Form
    {
        ...
        public CustomersForm()
        {
            ...
            // ── Header ────────────────────────────────────────────────────
            var header = UITheme.CreateHeader("🧑  Customers", "Manage customer records and contacts");
            Controls.Add(header);
            ...
            var formTitle = UITheme.CreateLabel("Customer Details", 16, 12);
            ...
            PlaceholderHelper.Set(name, "Customer Name");
